...
dw_edit_chart(
  ...
  intro = "Search by county in the table below to see what the gas prices are where you're traveling throughout Thanksgiving Week. Table is ranked and sorted by most expensive to least expensive.",
  byline = 'Susie Webb/Get the Facts Data Team',
  source_name = 'AAA',
  source_url = 'aaa.com',
  annotate = paste0("<i>Data as of ",today_head," and represents the previous day's average regular gas cost. Any NA values mean that there was not enough data to calcualte the price.")
  )
