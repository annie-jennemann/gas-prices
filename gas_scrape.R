...
dw_edit_chart(
  ...
  source_name = 'AAA',
  source_url = 'aaa.com',
  annotate = paste0("<i>Data as of ",today_head," and represents the previous day's average regular gas cost. Any "NA" values means that there was not enough data to calcualte the price.")
  )
